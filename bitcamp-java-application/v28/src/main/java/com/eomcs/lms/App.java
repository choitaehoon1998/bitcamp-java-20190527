  ...
  private static void loadMemberData() {
    ...
    try {
      ...
      while(scan.hasNextLine()) {
        ...
        member.setNo(Integer.parseInt(data[2]));
  ...
  private static void saveMemberData() {
    ...
    try {
      ...
      while(scan.hasNextLine()) {
        ...
        //배열의 각항목의 값을 lesson 객체에담는다
        board.setContents(data[0]);
        board.setCreatedDate(Date.valueOf(data[1]));
        board.setNo(Integer.parseInt(data[2]));
