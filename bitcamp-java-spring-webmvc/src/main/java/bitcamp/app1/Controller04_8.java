...
public class Controller04_8 {
  ...
  // 주의 !
  // => DispactherServlet 를 web.xml에 배치할때 <multipart-config/> 태그를 추가해야한다 
  // => webApplicationInitalizer 를 통해 DispatcherServlet 을 배치했다면, 
  //    App1WebApplicationInitalizer 클래스를 참고하라 
  // 테스트:
