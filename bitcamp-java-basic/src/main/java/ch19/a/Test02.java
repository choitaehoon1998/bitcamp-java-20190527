...
public class Test02 {
  ...
  // => 다른 스태틱 멤버 
  static int a; //Test02.A.a
  static void f1() {}//Test02.A.f1
  static {}//클래스 로딩할떄 자동으로 실행
  
  
  // 2) non-static nested class = inner class
  // => 바깥 클래스의 특정 인스턴스에 종속되는 클래스.
  class B {}// ex) Test02.B obj = new t.B() {}
  
  //=> 다른인스턴스 멤버
  int b; // t.b = 100; 
  void f2() {} // t. f2();
  {}// 인스턴스 생성된후 생성자 호출전에 실행  . 
  public static void main(String[] args) {
    ...
    Object obj = new Object() {
      public void f1() {
        // object 를 상소받은 익명클ㄹ래스를 만들고 f1메서드를 추가한다 .
