...
public class Test04 {
  public static void main(String[] args) {
    ...
    Car obj3 = new Car("티코") {// == new class명(?) extends car
      @Override
      public void run() {
    ...
    //
    Pen obj4 = new Pen() {// == new class명(?) implements pen
      @Override
      public void write() {
    ...
    // 주의 
    // 수퍼 클래스와 인터페이스를 동시에 지정하여 익명 클래스 만들수 없다 
    // 여러 인터페이스를 구현한 익명 클래스를 만들수없다 .
    //Car obj 5 = new Car,pen(){}// 컴파일 오류 ! 이런문법이다 
  }
  
  // 스태틱 메서드 
  public static void m1() {
    // 다른 메서드(예: main())에 정의된 로컬 클래스를 사용할수없다 . 
