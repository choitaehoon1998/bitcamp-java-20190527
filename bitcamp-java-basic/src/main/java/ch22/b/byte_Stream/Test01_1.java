...
public class Test01_1 {
  public static void main(String[] args) {
    ...
    try {
      ...
      //    오직 1바이트만 출력한다.   
      out.write(2);      //0x0000002
      out.write(40);    //0x0000028
      out.write(100);   //0x0000064
      out.write(101);   //0x0000065
      out.write(102);   //0x0000066
      out.write(127);   //0x000007f
      out.write(0x11223344); // 00010001 00100010 00110011 01000100
      out.write(0x55667788); // 맨 끝 1바이트만 출력한다.
      out.write(0x11223344);    //0x0041
      out.write(0x55667788);    //0xac00
      out.write('A');
      out.write('가');
      out.close();
