...
CREATE TABLE lectures (
  lectur_id  INTEGER      NOT NULL COMMENT '강의번호', -- 강의번호
...
ALTER TABLE lectures
  MODIFY COLUMN lectur_id INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의번호';
...
CREATE TABLE centers (
  ...
  bs_addr   VARCHAR(255) NULL     COMMENT '기본주소', -- 기본주소
